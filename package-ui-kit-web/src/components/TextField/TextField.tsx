...
const getInputAdornmentTextColor = ({ disabled }: TextFieldProps): string => {
  if (disabled) {
    return Colors.getWithAlpha('subtitleText', 0.5);
  } else {
    return Colors.get('subtitleText');
  }
};
  ...
  &&& {
    ...
    ${InputAdornment} {
      ...
      > p {
        ...
        font-weight: 600;
        font-family: Inter;
        color: ${getInputAdornmentTextColor};
      }
    }
