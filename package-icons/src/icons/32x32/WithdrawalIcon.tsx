...
export const WithdrawalIcon: React.FunctionComponent<IconContentComponentProps> = Icon(
  {
    size: 32,
    icon: (
      <React.Fragment>
        <g
          id="transactional/withdrawal"
          stroke="none"
          strokeWidth="1"
          fill="none"
          fillRule="evenodd"
        >
          ...
          <path
            ...
            stroke="currentColor"
            fill="none"
            transform="translate(16.000000, 12.000000) rotate(-90.000000) translate(-16.000000, -12.000000) "
          />
        </g>
      </React.Fragment>
    ),
